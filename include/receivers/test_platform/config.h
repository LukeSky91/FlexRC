...
#define BATTERY_ADC_REF_MV 5000UL
#define BATTERY_DIVIDER_R_TOP_OHM 100000UL
#define BATTERY_DIVIDER_R_BOTTOM_OHM 100000UL
#define BATTERY_CELL_EMPTY_MV 3300U
#define BATTERY_CELL_FULL_MV 4200U
